data = {
  "ref": "refs/heads/temp",
  "before": "940baa190b9c47f0a0f1af499512347bbe17b282",
  "after": "5c56595daf49c73b61b317760767e3120cd1dd43",
  "repository": {
    "id": 851909280,
    ...
    "owner": {
      "name": "venkatesh939",
      "email": "32451027+venkatesh939@users.noreply.github.com",
      "login": "venkatesh939",
      "id": 32451027,
    ...
    "description": None,
    "fork": False,
    "url": "https://github.com/venkatesh939/action-repo",
    ...
    "created_at": 1725402798,
    "updated_at": "2024-09-03T23:09:37Z",
    "pushed_at": 1725407531,
  ...
  "forced": False,
  "base_ref": None,
  "compare": "https://github.com/venkatesh939/action-repo/compare/940baa190b9c...5c56595daf49",
  "commits": [
    {
      "id": "5c56595daf49c73b61b317760767e3120cd1dd43",
      "tree_id": "95086e51756c51442a326e11b42002369913b698",
      "distinct": True,
      "message": "added temp",
      "timestamp": "2024-09-04T05:22:07+05:30",
      "url": "https://github.com/venkatesh939/action-repo/commit/5c56595daf49c73b61b317760767e3120cd1dd43",
      "author": {
        "name": "venkatesh",
        "email": "32451027+venkatesh939@users.noreply.github.com",
        "username": "venkatesh939"
      },
      "committer": {
        "name": "venkatesh",
        "email": "32451027+venkatesh939@users.noreply.github.com",
...
def extract_info(data):
    ...
    # record = {
    #     "_id": data['commits'].get("id"),
    #     "request_id": data.commits.get("id"),  # Assuming `id` is the request_id
    #     "author": data.commits.get("author", {}).get("name"),
    #     "action": "PUSH" if "Merge pull request" not in data.commits.get("message", "") else "MERGE",
    #     "from_branch": data.get("before"),
    #     "to_branch": data.get("after"),
    #     "timestamp": data.commits.get("timestamp")
    # }
    
    record = data.get("commits", [])[0].get('id')
